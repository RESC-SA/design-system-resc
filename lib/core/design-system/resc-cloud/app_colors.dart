...
extension AppColorsExtension on BuildContext {
  ...
  /// Card fill: tertiary background in light, translucent white in dark.
  Color get liquidCardFill =>
      isDark ? const Color(0x0BFFFFFF) : AppColors.backgroundTertiary;

  /// Card shadow — depth via shadow, no border. Light: soft black.
  /// Dark: deeper pure-black for elevation.
